...
namespace GTA
{
    public sealed partial class TaskInvoker
    {
        ...
        public void StartMoveNetworkByNameWithInitParams(string networkName,
            ...
            MoveNetworkFlags flags = MoveNetworkFlags.Default)
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b1493, nameof(TaskInvoker),
        ...
        public void StartMoveNetworkAdvancedByNameWithInitParams(string networkName,
            ...
            MoveNetworkFlags flags = MoveNetworkFlags.Default)
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b1868, nameof(TaskInvoker),
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b1290_1, nameof(TaskInvoker),
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b2189, nameof(TaskInvoker),
