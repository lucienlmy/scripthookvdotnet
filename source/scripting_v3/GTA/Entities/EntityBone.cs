...
namespace GTA
{
    public class EntityBone
    {
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b791_2, nameof(EntityBone),
                nameof(AttachToBone));
        ...
        public void AttachToBoneYForward(EntityBone boneOfSecondEntity, bool activeCollisions = true,
            bool useBasicAttachIfPed = false)
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b791_2, nameof(Entity),
