...
namespace GTA
{
    public sealed partial class Vehicle : Entity
    {
        ...
        public bool HasLowriderHydraulics
            => Game.FileVersion >= ExeVersions.b505_2
        ...
        public bool HasRocketBoost
            => Game.FileVersion >= ExeVersions.b944_2
        ...
        public bool IsParachuteDeployed
            => Game.FileVersion >= ExeVersions.b1011_1
        ...
        {
            get => Game.FileVersion >= ExeVersions.b944_2
                && Function.Call<bool>(Hash.IS_ROCKET_BOOST_ACTIVE, Handle);
            set
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b944_2, nameof(Vehicle), nameof(IsRocketBoostActive));
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b505_2, nameof(Vehicle), nameof(SetHydraulicsControl));
        ...
        /// </value>
        public bool AllowRappel => Game.FileVersion >= ExeVersions.b757_2
        ...
        public VehicleType Type
        {
            get
            {
                ...
                if (vehTypeInt >= 6 && Game.FileVersion < ExeVersions.b944_2)
                {
                    vehTypeInt += 2;
                }
        ...
        public int HighGear
        {
            ...
            set
            {
                ...
                if (Game.FileVersion >= ExeVersions.b1604)
                {
                    if (value > 10)
                    {
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b1604, nameof(Vehicle), nameof(SetReducedGripLevel));
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b1011_1, nameof(Vehicle), nameof(GetRestrictedAmmoCount));
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b944_2, nameof(Vehicle), nameof(SetRestrictedAmmoCount));
        ...
        public int BombAmmoCount
        {
            get
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b1180_2, nameof(Vehicle), nameof(GetRestrictedAmmoCount));
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b1103_2, nameof(Vehicle), nameof(SetTrailerLegsLowered));
        ...
        public bool IsBeingBroughtToHalt
            => Game.FileVersion >= ExeVersions.b1493
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b1103_2, nameof(Vehicle), nameof(StopBringingToHalt));
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b944_2, nameof(Vehicle), nameof(StartParachuting));
        ...
        public float SpecialFlightModeTargetRatio
        {
            ...
            set
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b1290_1, nameof(Vehicle), nameof(SpecialFlightModeTargetRatio));
        ...
        public float SpecialFlightModeCurrentRatio
        {
            ...
            set
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b1290_1, nameof(Vehicle), nameof(SpecialFlightModeCurrentRatio));
        ...
        public float SpecialFlightModeWingRatio
        {
            ...
            set
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b1290_1, nameof(Vehicle), nameof(SpecialFlightModeWingRatio));
        ...
        public bool AreWingsEnabledForSpecialFlightMode
        {
            ...
            set
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersions.b1290_1, nameof(Vehicle), nameof(AreWingsEnabledForSpecialFlightMode));
