...
namespace GTA
{
    public sealed class VehicleModCollection
    {
        ...
        public VehicleColor TrimColor
        {
            get
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b505_2, nameof(VehicleModCollection), nameof(TrimColor));
        ...
        public VehicleColor DashboardColor
        {
            get
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b505_2, nameof(VehicleModCollection), nameof(DashboardColor));
