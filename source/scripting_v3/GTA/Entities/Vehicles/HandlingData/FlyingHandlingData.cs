    ...
    public sealed class FlyingHandlingData : BaseSubHandlingData
    {
        ...
        public float YawMultiplier
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x1C : 0x14;
        ...
        public float YawStabilize
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x20 : 0x18;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float SideSlipMultiplier
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x24 : 0x1C;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float RollMultiplier
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x2C : 0x20;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float RollStabilize
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x30 : 0x24;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float PitchMultiplier
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x38 : 0x28;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float PitchStabilize
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x3C : 0x2C;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float FormLiftMultiplier
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x44 : 0x30;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float AttackLiftMultiplier
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x48 : 0x34;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float AttackDiveMultiplier
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x4C : 0x38;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float GearDownDragV
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x50 : 0x3C;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float GearDownLiftMultiplier
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x54 : 0x40;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float WindMultiplier
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x58 : 0x44;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public float MoveResistance
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x5C : 0x48;
                return SHVDN.MemDataMarshal.ReadFloat(MemoryAddress + offset);
            }
            set
            {
        ...
        public Vector3 VectorTurnResistance
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x60 : 0x50;
        ...
        public Vector3 VectorSpeedResistance
        {
            get
            {
                ...
                int offset = Game.FileVersion >= ExeVersionConsts.b1180_2 ? 0x70 : 0x60;
                return new Vector3(SHVDN.MemDataMarshal.ReadVector3(MemoryAddress + offset));
            }
            set
            {
        ...
        public float ExtraLiftWithRoll
        {
            get
            {
                if (!IsValid || Game.FileVersion < ExeVersionConsts.b1180_2)
                {
                    return 0f;
                }
            ...
            set
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b1180_2, nameof(FlyingHandlingData), nameof(ExtraLiftWithRoll));
