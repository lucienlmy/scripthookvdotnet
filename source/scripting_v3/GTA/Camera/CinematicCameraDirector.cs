...
namespace GTA
{
    ...
    public static class CinematicCameraDirector
    {
        ...
        public static bool IsRenderingMountedCam
        {
            get
            {
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b372_2,
        ...
        public static bool IsCinematicCamInputActive
        {
            get
            {
                ...
                // worth it, though...
                GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b1493,
