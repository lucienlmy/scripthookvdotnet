...
namespace GTA
{
    ...
    public sealed partial class Camera : PoolObject, ISpatial
    {
        ...
        {
            Function.Call(Hash.SHAKE_CAM, Handle, shakeType.GetInternalName(), amplitude);
        }
        /// <summary>
        /// Apples a predefined shake to the camera.
        /// </summary>
        ...
        {
            Function.Call(Hash.POINT_CAM_AT_PED_BONE, Handle, target.Owner.Handle, (int)target
                .Tag, offset.X, offset.Y, offset.Z, true);
        }
        /// <summary>
        ...
        {
            Function.Call(Hash.ATTACH_CAM_TO_PED_BONE, Handle, pedBone.Owner.Handle, (int)pedBone
                .Tag, offset.X, offset.Y, offset.Z, true);
        }
        ...
        {
            GameVersionNotSupportedException.ThrowIfNotSupported(ExeVersionConsts.b1290_1,
